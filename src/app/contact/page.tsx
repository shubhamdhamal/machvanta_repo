          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8">
                Ready to transform your industrial processes? Contact our team of automation
                experts to discuss your requirements and discover how we can help you achieve
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 px-6 rounded-lg font-semibold text-lg hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubmitting ? (
                    <>
            ...
            {[
              {
                ...
                answer: 'We serve a wide range of industries including automotive, FMCG, packaging, pharmaceuticals, and manufacturing sectors.',
              },
              {
                question: 'How long does a typical project take?',
                answer: 'Project timelines vary based on complexity, but most automation projects range from 2-6 months from design to commissioning.',
              },
              {
                question: 'Do you provide ongoing support?',
                answer: 'Yes, we offer comprehensive support including 24/7 technical assistance, preventive maintenance, and system upgrades.',
              },
              {
                question: 'Can you work with existing systems?',
                answer: 'Absolutely! We specialize in retrofitting and upgrading existing systems to modern automation standards.',
              },
            ].map((faq, index) => (
              <motion.div
                key={index}
